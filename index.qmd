...
<div style="display:none" id="original-content">
  ...
  <div id="original-education-text">With my unique experience in the music industry, international background in Psychological Science and my own activity as a drummer and vocalist, I will help you to enhance your performance while prioritising your health - for a sustainable and fulfilling career!</div>
...
<style>
  ...
  /* 
   * The absolute positioned overlay image that will never be affected by layout changes 
   */
   ...
   * to maintain layout structure but allow our fixed overlay image to show
   */
  ...
  /* Final text positioning - moved closer to image */
  #final-text {
    display: block;
    min-height: 24px;
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function createImageOverlay() {
      ...
      // Create our overlay image element
      ...
      // Position the overlay exactly where the original image is
