    ...
    <table style="width:100%; border:none; background-color: rgba(25,25,25,0.8); border-radius:8px; padding:10px;">
        <tr>
            <td style="width:25%; vertical-align:top; padding-right:20px;">
                <img src="img/DE_Gro.png" alt="Album Cover" style="width:70%; border-radius:5px; margin-top:12px; margin-left:12px;">
            </td>
            <td style="width:75%; vertical-align:top;">
                <p style="font-size: 14px; margin-bottom:5px;">Track 1: Childhood Trauma</p>
                <audio controls style="height:12px;" preload="metadata" src="audio/CT.wav" controlsList="nodownload"></audio>
                <p style="font-size: 14px; margin-bottom:5px;">Track 2: Seek & Hide</p>
                <audio controls style="height:12px;" preload="metadata" src="audio/Seek&Hide.wav" controlsList="nodownload"></audio>
                <p style="font-size: 14px; margin-bottom:5px;">Track 3: Abduction/Corruption</p>
                <audio controls style="height:12px;" preload="metadata" src="audio/abduct.m4a" controlsList="nodownload"></audio>
            </td>
        </tr>
    </table>
...
<body>
    ...
    <table style="width:100%; border:none; background-color: rgba(25,25,25,0.8); border-radius:8px; padding:10px;">
        <tr>
            <td style="width:25%; vertical-align:top; padding-right:20px;">
                <img src="img/sky.jpeg" alt="Album Cover" style="width:70%; border-radius:5px; margin-top:12px; margin-left:12px;">
            </td>
            <td style="width:75%; vertical-align:top;">
                <p style="font-size: 14px; margin-bottom:5px;">Demo Track 1: Intro (Instrumental)</p>
                <audio controls style="height:12px;" preload="metadata" src="audio/Intro.wav" controlsList="nodownload"></audio>
                <p style="font-size: 14px; margin-bottom:5px;">Demo Track 2: Dark (Instrumental)</p>
                <audio controls style="height:12px;" preload="metadata" src="audio/Dark.wav" controlsList="nodownload"></audio>
                <p style="font-size: 14px; margin-bottom:5px;">Demo Track 3: Shadow (Instrumental)</p>
                <audio controls style="height:12px;" preload="metadata" src="audio/Shadow.wav" controlsList="nodownload"></audio>
                <p style="font-size: 14px; margin-bottom:5px;">Demo Track 4: Shadow Of The Sun (Acoustic)</p>
                <audio controls style="height:12px;" preload="metadata" src="audio/ShadowOfTheSunAcoustic.wav" controlsList="nodownload"></audio>
            </td>
        </tr>
    </table>
    <p> **Genre**: Psychedelic Rock / Classic Rock <br>
        **Instrument**: Drums & Vocals <br>
        **Release Date**: 11th of June 2021 <br>
        **Location**: Groningen, The Netherlands </p>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    // FIX 1: Ensure only one audio player plays at a time
    ...
    audioElements.forEach(audio => {
      audio.addEventListener('play', function() {
        ...
        // Stop all iframes when audio plays
    ...
    // FIX 2: Stop all media when any iframe is clicked
    const iframeElements = document.querySelectorAll('iframe');
    iframeElements.forEach(iframe => {
      iframe.addEventListener('mousedown', function() {
        ...
        iframeElements.forEach(otherIframe => {
          if (otherIframe !== this && otherIframe.src) {
            const currentSrc = otherIframe.src;
            otherIframe.src = '';
            setTimeout(() => { otherIframe.src = currentSrc; }, 10);
          }
        });
      });
    });
...
<!-- Concert Videos with Fixed Google Drive Embeds -->

<h3 style="font-size: 20px;">Flumine - Dis/Closure | Vocals | Concert at Roy Mölndal | Gothenburg | SE | 2023</h3>
<iframe src="https://drive.google.com/file/d/1wPqJtaUivmxZX1ksPXKIqcSHGX7RsIWS/preview?rm=minimal"
        width="800" height="450"
        allow="autoplay"
        allowfullscreen></iframe>

<h3 style="font-size: 20px;">Flumine - Flumine | Vocals | Concert at Ericsson | Gothenburg | SE | 2022</h3>
<iframe src="https://drive.google.com/file/d/1ckrUBpavzr2wORyS8hBmN-xLK88eVayd/preview?rm=minimal"
        width="800" height="450"
        allow="autoplay"
        allowfullscreen></iframe>

<h3 style="font-size: 20px;">Ioana Iorgu - Bad Dreams | Drums | Concert at Simplon | Groningen | NL | 2021</h3>
<iframe src="https://drive.google.com/file/d/1P1FdJ6S-VaNnX7q5s2sQ9bSQrRIbeSHZ/preview?rm=minimal"
        width="800" height="450"
        allow="autoplay"
        allowfullscreen></iframe>
